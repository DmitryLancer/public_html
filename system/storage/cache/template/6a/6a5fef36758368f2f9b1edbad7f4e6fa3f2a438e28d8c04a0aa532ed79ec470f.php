...
class __TwigTemplate_606ff5d0d354b7fe2ff042a05734d47f077d40c769b4c98f61aaa1a7702cadcc extends \Twig\Template
{
    private $source;
    private $macros = [];
          ...
          <tr>
            ...
            ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                        // line 104
                        echo "            ";
                        if ((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, $context["product"], "attribute", [], "any", false, false, false, 104)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[$context["key"]] ?? null) : null)) {
                            // line 105
                            echo "            <td> ";
                            echo (($__internal_compile_1 = twig_get_attribute($this->env, $this->source, $context["product"], "attribute", [], "any", false, false, false, 105)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[$context["key"]] ?? null) : null);
                            echo "</td>
            ";
                        } else {
                            // line 107
